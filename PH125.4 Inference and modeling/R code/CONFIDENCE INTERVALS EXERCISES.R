...
# of Clinton voters. Save the lower and then the upper confidence 
...
# Add a statement to this line of code that will add a new column 
# named `d_hat` to `polls`. The new column should contain the difference 
...
# in the proportions of voters. Save the lower and then the upper confidence 
# interval to a variable called `ci`.
...
# Summarize the average `hit` result to determine the proportion of 
# polls with confidence intervals include the actual value. Save the result
